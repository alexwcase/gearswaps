...
-- Added Buff Timers for Reward, Spur, Run Wild, and certain Ready Moves - set DisplayPetBuffTimers to 'false to disable
--
...
function user_setup()
    ...
    state.JugMode = M{['description']='Jug Mode', 'Meaty Broth', 'Windy Greens', 'Livid Broth',
        'Airy Broth', 'Tant. Broth', 'Bubbly Broth', 'Spicy Broth', 'Livid Broth', 'Bug-Ridden Broth', 'Electrified Broth'}
    ...
    -- Ehgh?? --
    state.FoodMode = M{['description']='Food Mode', 'Pet Food Eta', 'Pet Food Theta'}
    send_command('bind != gs c cycle FoodMode')
...
function init_gear_sets()
    ...
    Mantle_Ready = {name= "Pastoralist's Mantle", augments={"STR+1 DEX+1", "Accuracy+2", "Pet: Accuracy+20 Pet: Rng. Acc.+20"}}
    ...
    -- Pet_PDT_body = {name="Acro Surcoat", augments={'Pet: DEF+22','Pet: "Regen"+3','Pet: Damage taken -4%',}}
    -- Pet_PDT_hands = {name="Valorous Mitts", augments={'Pet: "Mag.Atk.Bns."+3','Pet: Phys. dmg. taken -5%','System: 1 ID: 1794 Val: 7','Pet: Accuracy+9 Pet: Rng. Acc.+9','Pet: Attack+4 Pet: Rng.Atk.+4',}}
    -- Pet_PDT_legs = {name="Valor. Hose", augments={'Pet: Phys. dmg. taken -5%','System: 1 ID: 1794 Val: 6','Pet: Accuracy+14 Pet: Rng. Acc.+14','Pet: Attack+12 Pet: Rng.Atk.+12',}}
    -- Pet_PDT_feet = {name="Valorous Greaves", augments={'Pet: Attack+12 Pet: Rng.Atk.+12','Pet: Phys. dmg. taken -5%','System: 1 ID: 1794 Val: 8',}}
    -- Pet_PDT_back = {name="Pastoralist's Mantle", augments={'STR+1 DEX+1','Accuracy+1','Pet: Accuracy+20 Pet: Rng. Acc.+20','Pet: Damage taken -5%',}}

    -- Pet_PDT_head = "Anwig Salade"
    -- Pet_PDT_head = "Anwig Salade"
    Pet_PDT_head = "Anwig Salade"
    Pet_PDT_body = {name="Acro Surcoat", augments={'Pet: Mag. Acc.+25','Pet: "Regen"+3','Pet: Damage taken -3%',}}
    Pet_PDT_hands = {name="Acro Gauntlets", augments={'Pet: DEF+22','Pet: "Regen"+3','Pet: Damage taken -4%',}}
    Pet_PDT_legs = {name="Ferine Quijotes +1"}
    Pet_PDT_feet = {name="Acro Leggings", augments={'Pet: "Regen"+2','Pet: Damage taken -4%',}}
    Pet_PDT_belt = "Primal Belt"



    Pet_MDT_head = "Anwig Salade"
    Pet_MDT_body = {name="Acro Surcoat", augments={'Pet: Mag. Acc.+25','Pet: "Regen"+3','Pet: Damage taken -3%',}}
    ...
    Pet_DT_body = {name="Acro Surcoat", augments={'Pet: Mag. Acc.+25','Pet: "Regen"+3','Pet: Damage taken -3%',}}
    ...
    Pet_DT_feet = {name="Acro Leggings", augments={'Pet: DEF+25','Pet: "Regen"+2','Pet: Damage taken -4%',}}
    Pet_DT_back = Mantle_DT


    Pet_Regen_head = {name="Taeon Chapeau", augments={'Pet: Mag. Evasion+17','Pet: "Regen"+3','Pet: Damage taken -4%',}}
    Pet_Regen_body = {name="Acro Surcoat", augments={'Pet: DEF+22','Pet: "Regen"+3','Pet: Damage taken -4%',}}
    Pet_Regen_hands = {name="Valorous Mitts", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: "Regen"+5','System: 1 ID: 1793 Val: 6','Pet: Attack+15 Pet: Rng.Atk.+15',}}
    ...
    -- Ready_Atk_body = {name="Valorous Mail", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: Phys. dmg. taken -2%','System: 1 ID: 1792 Val: 13','Pet: Attack+15 Pet: Rng.Atk.+15',}}
    ...
    -- Ready_Atk_legs = {name="Valor. Hose", augments={'Pet: Attack+28 Pet: Rng.Atk.+28','System: 1 ID: 1792 Val: 13','Pet: Accuracy+3 Pet: Rng. Acc.+3',}}
    -- Ready_Atk_feet = {name="Valorous Greaves", augments={'Pet: Attack+30 Pet: Rng.Atk.+30','"Dbl.Atk."+4','System: 1 ID: 1793 Val: 7','Pet: Accuracy+14 Pet: Rng. Acc.+14',}}
    -- Ready_Atk_back = {name="Pastoralist's Mantle", augments={'STR+1 DEX+1','Accuracy+1','Pet: Accuracy+20 Pet: Rng. Acc.+20','Pet: Damage taken -5%',}}

    Ready_Atk_head = "Emicho Coronet +1"
    Ready_Atk_body = {name="Totemic Helm"}
    Ready_Atk_hands = {name="Acro gauntlets", augments={'Pet: Haste+3%', 'Pet: "Dbl. Atk." +4'}}
    Ready_Atk_legs = {name="Totemic trousers"}
    Ready_Atk_feet = {name="Totemic Gaiters"}
    Ready_Atk_back = Mantle_Ready

    Ready_Acc_head = {name="Valorous Mask", augments={'Pet: Accuracy+30 Pet: Rng. Acc.+30','Pet: "Store TP"+8','System: 1 ID: 1793 Val: 4',}}
    Ready_Acc_body = {name="Valorous Mail", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: Phys. dmg. taken -2%','System: 1 ID: 1792 Val: 13','Pet: Attack+15 Pet: Rng.Atk.+15',}}
    Ready_Acc_hands = {name="Valorous Mitts", augments={'Pet: Accuracy+29 Pet: Rng. Acc.+29','Pet: "Regen"+5','System: 1 ID: 1793 Val: 6','Pet: Attack+15 Pet: Rng.Atk.+15',}}
    Ready_Acc_legs = {name="Valor. Hose", augments={'Pet: Accuracy+30 Pet: Rng. Acc.+30','System: 1 ID: 1793 Val: 5',}}
    Ready_Acc_feet = {name="Valorous Greaves", augments={'Pet: Accuracy+25 Pet: Rng. Acc.+25','System: 1 ID: 1793 Val: 14','Pet: Attack+4 Pet: Rng.Atk.+4',}}
    Ready_Acc_back = Mantle_Ready

    Ready_MAB_head = {name="Valorous Mask", augments={'Pet: "Mag.Atk.Bns."+26','System: 1 ID: 1796 Val: 14','Pet: Attack+4 Pet: Rng.Atk.+4',}}
    Ready_MAB_body = {name="Acro Surcoat", augments={'Pet: "Mag.Atk.Bns."+25',}}
    Ready_MAB_hands = { name="Valorous Mitts", augments={'Pet: "Mag.Atk.Bns."+29','Pet: "Store TP"+9','System: 1 ID: 1796 Val: 11','Pet: Attack+4 Pet: Rng.Atk.+4',}}
    Ready_MAB_legs = {name="Valor. Hose", augments={'Pet: "Mag.Atk.Bns."+30','System: 1 ID: 1796 Val: 9','Pet: Accuracy+7 Pet: Rng. Acc.+7','Pet: Attack+6 Pet: Rng.Atk.+6',}}
    Ready_MAB_feet = {name="Valorous Greaves", augments={'Pet: "Mag.Atk.Bns."+30','System: 1 ID: 1796 Val: 12','Pet: Accuracy+9 Pet: Rng. Acc.+9','Pet: Attack+15 Pet: Rng.Atk.+15',}}
    ...
    Sweeping_Gouge_body = {name="Acro Surcoat", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Pet: "Dbl. Atk."+5','Pet: Haste+5',}}
    Sweeping_Gouge_hands = {name="Valorous Mitts", augments={'Pet: Accuracy+28 Pet: Rng. Acc.+28','Pet: "Dbl. Atk."+3','Pet: Attack+10 Pet: Rng.Atk.+10',}}
    Sweeping_Gouge_legs = {name="Taeon Tights", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl. Atk."+5','Pet: Haste+5',}}
    Sweeping_Gouge_feet = {name="Taeon Boots", augments={'Pet: Attack+23 Pet: Rng.Atk.+23','Pet: "Dbl. Atk."+5','Pet: Haste+5',}}

    Hybrid_head = {name="Taeon Chapeau", augments={'Pet: Mag. Evasion+6','Pet: "Regen"+3','Pet: Damage taken -4%',}}
    ...
    sets.enmity = {main="Mafic Cudgel",sub="Breidox",ammo="Paeapua",
        ...
        back="Earthcry Mantle",waist="Trance Belt",legs="Obatala Subligar",feet="Rager Ledelsens +1"}
    ...
    sets.midcast.SweepingGouge = set_combine(sets.midcast.Pet.WS, {
        neck="Ferine Necklace",ear2="Domesticator's Earring",
        body=Sweeping_Gouge_body,
        hands=Sweeping_Gouge_hands,
        legs=Sweeping_Gouge_legs,
        feet=Sweeping_Gouge_feet})

    sets.midcast.Pet.MedAcc = set_combine(sets.midcast.Pet.WS, {ear2="Ferine Earring",
        body=Ready_Acc_body,
        legs=Ready_Acc_legs})
    sets.midcast.Pet.HighAcc = set_combine(sets.midcast.Pet.WS, {head=Ready_Acc_head,
        ear1="Spinel Earring",
        ear2="Ferine Earring",
        body=Ready_Acc_body,
    ...
    sets.midcast.SweepingGougeNE = set_combine(sets.midcast.SweepingGouge, {main="Aymur"})
    ...
    sets.midcast.SweepingGougeDWNE = set_combine(sets.midcast.SweepingGougeNE, {sub=Ready_Atk_Axe})
    ...
    sets.UnleashMABAxes = {main=Ready_Unleash_MAB_Axe}
    ...
    sets.idle = {ammo="Demonry Core",
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs="Iuitl Tights +1",feet="Skadi's Jambeaux +1"}
    ...
    --     feet=Pet_Melee_feet}
        sets.idle.Pet.Engaged = {ammo="Demonry Core",
	        head=Pet_PDT_head,
	        neck="Ferine Necklace",ear1="Handler's Earring",ear2="Domesticator's Earring",
	        body=Pet_PDT_body,
	        hands=Pet_PDT_hands,
	        ring1="Thurandaut Ring",ring2="Defending Ring",
	        back=Pet_DT_back,
    ...
    -- DEFENSE SETS
    sets.defense.PDT = {
        head="Jumalik Helm",neck="Loricate Torque +1",ear2="Genmei Earring",
        body="Jumalik Mail",hands="Umuthi Gloves",ring1="Patricius Ring",ring2="Defending Ring",
        back="Solemnity Cape",waist="Flume Belt +1",legs="Iuitl Tights +1",feet="Amm Greaves"}
    ...
    sets.defense.PetMDT = set_combine(sets.defense.PetPDT, {main=Pet_MDT_AxeMain,
        sub=Pet_MDT_AxeSub,
    ...
    sets.precast.FC = {main="Shukuyukama",sub="Vivid Strap",
        ammo="Sapience Orb",
        head=FC_head,
        neck="Baetyl Pendant",ear1="Loquacious Earring",ear2="Enchanter Earring +1",
        body=FC_body,
        hands=FC_hands,
    ...
    sets.midcast.FastRecast = {
        ...
        back="Solemnity Cape",waist="Incarnation Sash",
        legs=FC_legs,
        feet=FC_feet}
    ...
    sets.midcast.Cure = {ammo="Quartz Tathlum +1",
        ...
        ring1="Lebeche Ring",ring2="Asklepian Ring",back=Pet_DT_back,waist="Gishdubar Sash",
        ...
        if physical_ready_moves:contains(spell.name) then
            if state.PetMode.value == 'PetOnly' then
                ...
                elseif state.OffenseMode.value == 'MedAcc' or state.OffenseMode.value == 'MedAccHaste' then
                    ...
                    if player.sub_job == 'NIN' or player.sub_job == 'DNC' then
                        if spell.english == 'Sweeping Gouge' then
                            equip(set_combine(sets.midcast.SweepingGougeDWNE, sets.midcast.Pet[state.CorrelationMode.value]))
                        else
                            equip(set_combine(sets.midcast.Pet.ReadyDWNE, sets.midcast.Pet[state.CorrelationMode.value]))
                        end
                    else
                        if spell.english == 'Sweeping Gouge' then
                            equip(set_combine(sets.midcast.SweepingGougeNE, sets.midcast.Pet[state.CorrelationMode.value]))
                        else
                ...
                elseif state.OffenseMode.value == 'MedAcc' then
                    ...
                    if spell.english == 'Sweeping Gouge' then
                        equip(set_combine(sets.midcast.SweepingGouge, sets.midcast.Pet[state.CorrelationMode.value]))
                    else
