...
function user_setup()
	...
	-- Capes --
	cape_skill = {name="Lifestream Cape", augments={'Geomancy skill +9', 'Indi. eff. dur. +16', 'Pet: Damage taken -3%'}}
	cape_dt = {name="Lifestream Cape", augments={'Geomancy skill +4', 'Indi. eff. dur. +10', 
			'Damage taken -1%','Pet: Damage taken -4%'}}
...
function init_gear_sets()
	...
	sets.midcast['Life Cycle'] = {body="Geo. Tunic +1", head="Azimuth hood +1"}
	...
	sets.midcast['Life Cycle'].Pet = {body="Geo. Tunic +1", head="Azimuth hood +1"}
	sets.midcast['Mending Halation'].Pet = {legs="Bagua Pants +1"}        sets.midcast.Bolster.Pet.Indi = {body="Bagua Tunic +1"}
	sets.midcast['Life Cycle'].Pet.Indi = {body="Geo. Tunic +1", head="Azimuth hood +1"}
