...
function get_sets()
        ...
        sets.PDT = {ammo="Honed tathlum",
                                        ...
                                        ear1="Zennaroi Earring",ear2="Ethereal Earring",
                                        body="Emet Harness +1",
                                        hands=QaaxoHand.Acc,
       ...
       sets.TP.Normal = {}  
        ...
        sets.TP.HighHaste.MidAcc = {ammo="Honed tathlum",
                                        head="Dampening Tam",
                                        neck="Defiant Collar",
        ...
        sets.TP.HighHaste.HighAcc = {ammo="Honed tathlum",
                                        head="Dampening Tam",
                                        neck="Subtlety Spectacles",
                                        ear1="Zennaroi Earring", ear2="Steelflash Earring",
                                        body="Adhemar Jacket",
                                        hands="Rawhide Gloves",
                                        ring1="Cacoethic Ring",ring2="Ramuh Ring +1",
                                        back="Lupine Cape",
                                        waist="Olseni Belt",
                                        legs="Samnuha Tights",
                                        feet="Rawhide Boots"}
        ...
        sets.Requiescat.Attack = {ammo="Hydrocera",
                                        ...
                                        body="Adhemar Jacket",
                                        hands="Adhemar Wristbands",
                                        ring1="Epona's ring",ring2="Aquasoul ring",
        ...
        sets.ChantDuCygne.AccuracyHigh = {ammo="Honed tathlum",
                                          head="Dampening Tam",
                                          neck="Fotia Gorget",
                                          ear1="Zennaroi earring",ear2="Bladeborn earring",
                                          body="Adhemar Jacket",
                                          hands="Adhemar Wristbands",
                                          ring1="Epona's ring",ring2="Ramuh Ring +1",
                                          back="Lupine Cape",
        ...
        sets.Expiacion.Accuracy = {ammo="Honed tathlum",
                                        head="Adhemar Bonnet",
                                        neck="Fotia Gorget",
                                        ear1="Zennaroi Earring",ear2="Cessance Earring",
                                        body="Adhemar Jacket",
        ...
        sets.WS.SanguineBlade = {ammo="Dosis Tathlum",
                                        ...
                                        body="Adhemar Jacket",
                                        hands="Nilas Gloves",
                                        ring1="Archon Ring",ring2="Aquasoul Ring",
                                        back="Cornflower cape",
                                        waist="Grunfeld Rope",
                                        legs="Lengo Pants",
                                        feet="Helios Boots"}
        ...
        sets.FlashNova.Attack ={ammo="",
                                   ...
                                   hands="Helios Gloves",
                                   ring1="Acumen Ring",ring2="Weatherspoon Ring",
                                   back="Cornflower Cape",
                                   waist="Eschan Stone",
                                   legs="Lengo Pants",
                                   feet="Helios Boots"}
        ...
        sets.BlueMagic.STR = {ammo="Floestone",
                                  ...
                                  body="Adhemar Jacket",
                                  hands="Adhemar Wristbands",
                                  ring1="Ifrit Ring +1",ring2="Rajas ring",
                                  back="Cornflower cape",
                                  waist="Grunfeld Rope",
                                  legs="Samnuha Tights",
                                  feet=TaeonBoots.TA}
        ...
        sets.BlueMagic.Cures = {ammo="Hydrocera",
                                        ...
                                        hands=TelchineGloves.CP,
                                        ring1="Dark ring",ring2="Aquasoul ring",
                                        back="Cornflower Cape",
                                        waist="Eschan Stone",
                                        legs="Gyve Trousers",
                                        feet="Medium's Sabots"}
       
        sets.BlueMagic.WhiteWind = {ammo="Floestone",
                                        head="Adhemar Bonnet",
                                        neck="Subtlety Spectacles",
                                        ear1="Suppanomimi",ear2="Ethereal Earring",
                                        body="Vrikodara Jupon",
                                        ...
                                        feet="Medium's Sabots"}
        --Sudden Lunge                                 
        sets.BlueMagic.Stun = {ammo="Floestone",
                                        head="Carmine Mask",
        ...
        sets.BlueMagic.MagicAccuracy = {ammo="Floestone",
                                        head="Amalric Coif",
                                        neck="Eddy necklace",
        ...
        sets.BlueMagic.Skill = {ammo="Floestone",
                                        head="Luh. Keffiyeh +1",
                                        neck="Jeweled collar",
                                        ear1="None",ear2="Ethereal earring",
                                        body="Assim. jubbah +1",
                                        hands="Rawhide Gloves",
        ...
        sets.BlueMagic.SkillRecast = {ammo="Floestone",
                                        head="Luh. Keffiyeh +1",
                                        neck="Twilight Torque",
                                        ear1="None",ear2="Ethereal earring",
                ...
                if spell.skill == 'Blue Magic' then
                        ...
                        if MagicalSpells:contains(spell.english) then
                                ...
                                elseif BlueMagic_Dark:contains(spell.english) then
                                        equipSet = equipSet.DarkNuke
                                elseif BlueMagic_Light:contains(spell.english) then
                                        equipSet = equipSet.LightNuke
